            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                ...
                <div class="md:col-span-2">
                    <div class="flex items-center mb-4">
                        <img src="https://img.freepik.com/vektor-gratis/vektor-desain-logo-rumah-sakit-salib-medis_53876-136743.jpg?semt=ais_hybrid&w=740&q=80" class="w-10 h-10 mr-1" />
                        <span class="text-xl font-bold text-gray-900">Klinik Sehat Sejahtera</span>
                    </div>
                    <p class="text-gray-600 text-sm leading-relaxed max-w-md">
                        Memberikan pelayanan kesehatan terbaik dengan standar profesional. 
                        Komitmen kami adalah kesehatan dan kesejahteraan pasien.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li>
                            <a href="#" class="text-gray-600 hover:text-primary-600 text-sm transition-colors duration-200">
                                Beranda
                            </a>
                        </li>
                        @auth
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-gray-600">
                        ...
                        <li class="flex items-start">
                            ...
                            <span>info@kliniksehatsejahtera.com</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="pt-8 border-t border-gray-200">
                <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                    ...
                    <div class="text-sm text-gray-500">
                        &copy; {{ date('Y') }} Klinik Sehat Sejahtera. All rights reserved.
                    </div>
